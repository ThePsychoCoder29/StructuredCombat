...
import net.kaicoyote.structuredcombat.entity.custom.entities.daggers.GoldDaggerProjectileEntity;
...
public class GoldDaggerRenderer extends EntityRenderer<GoldDaggerProjectileEntity>{
    ...
    public ResourceLocation getTextureLocation(GoldDaggerProjectileEntity goldDaggerProjectileEntity) {
        return new ResourceLocation(StructuredCombat.MOD_ID, "textures/entity/daggers/gold_dagger.png");
    }
}
