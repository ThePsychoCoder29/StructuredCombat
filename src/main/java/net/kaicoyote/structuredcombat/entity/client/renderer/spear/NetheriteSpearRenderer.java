...
public class NetheriteSpearRenderer extends EntityRenderer<NetheriteSpearProjectileEntity>{
    ...
    @Override
    public void render(NetheriteSpearProjectileEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, @NotNull MultiBufferSource pBuffer, int pPackedLight) {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull NetheriteSpearProjectileEntity netheriteSpearProjectileEntity) {
        return new ResourceLocation(StructuredCombat.MOD_ID, "textures/entity/spears/netherite_spear.png");
    }
}
