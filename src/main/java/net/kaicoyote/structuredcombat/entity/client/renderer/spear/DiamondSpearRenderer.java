...
import net.kaicoyote.structuredcombat.entity.custom.entities.spears.DiamondSpearProjectileEntity;
...
public class DiamondSpearRenderer extends EntityRenderer<DiamondSpearProjectileEntity>{
    ...
    public DiamondSpearRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new SpearWithGuardModel(pContext.bakeLayer(ModModelLayers.DIAMOND_SPEAR));
    }
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull DiamondSpearProjectileEntity diamondSpearProjectileEntity) {
        return new ResourceLocation(StructuredCombat.MOD_ID, "textures/entity/spears/diamond_spear.png");
    }
}
