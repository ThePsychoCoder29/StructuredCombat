...
public class WoodenSpearRenderer extends EntityRenderer<WoodenSpearProjectileEntity>{
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull WoodenSpearProjectileEntity woodenSpearProjectileEntity) {
        return new ResourceLocation(StructuredCombat.MOD_ID, "textures/entity/spears/wooden_spear.png");
    }
}
