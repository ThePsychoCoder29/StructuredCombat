...
public class HatchetModel extends Model {
	...
	public static LayerDefinition createLayer() {
        ...
        PartDefinition hatchet = partdefinition.addOrReplaceChild("hatchet", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -7.0F, -0.5F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
