...
public class ModToolTiers {
    public static final Tier WOODEN = TierSortingRegistry.registerTier(
            new ForgeTier(0, 0, 2, 0, 15 , ModTags.Blocks.NEEDS_STRUCTURED_COMBAT_TOOL, () -> Ingredient.of(ItemTags.PLANKS)),
    ...
    public static final Tier STONE = TierSortingRegistry.registerTier(
            new ForgeTier(0, 0, 4, 0, 5 , ModTags.Blocks.NEEDS_STRUCTURED_COMBAT_TOOL, () -> Ingredient.of(ItemTags.STONE_TOOL_MATERIALS)),
    ...
    public static final Tier IRON = TierSortingRegistry.registerTier(
            new ForgeTier(0, 0, 6, 0, 14 , ModTags.Blocks.NEEDS_STRUCTURED_COMBAT_TOOL, () -> Ingredient.of(Items.IRON_INGOT)),
    ...
    public static final Tier GOLD = TierSortingRegistry.registerTier(
            new ForgeTier(0, 0,  12, 0, 22 , ModTags.Blocks.NEEDS_STRUCTURED_COMBAT_TOOL, () -> Ingredient.of(Items.IRON_INGOT)),
    ...
    public static final Tier DIAMOND = TierSortingRegistry.registerTier(
            new ForgeTier(0, 0, 8, 0, 10 , ModTags.Blocks.NEEDS_STRUCTURED_COMBAT_TOOL, () -> Ingredient.of(Items.DIAMOND)),
    ...
    public static final Tier NETHERITE = TierSortingRegistry.registerTier(
            new ForgeTier(0, 0, 9, 0, 15 , ModTags.Blocks.NEEDS_STRUCTURED_COMBAT_TOOL, () -> Ingredient.of(Items.NETHERITE_INGOT)),
